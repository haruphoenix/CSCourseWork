...
*    Haru McClellan
* Summary:
*    This file reads in a file of reserved words, and places them into an array
*    of linked lists using a hash function.
******************************************************************************/
#include <iostream>
#include <fstream>
#include <string>
...
/*****************************************************************************
* Main reads the words from a file and places them into a list. It prints out
* the list
******************************************************************************/
      ...
      try
      {
         ...
         while (read >> word)
         {
            ...
            for (int i = 0; i < word.size(); i++)
               value += word[i];
            table[value % SIZE].insert(word, SIZE); // Add to hash table
         }
         // Print List
